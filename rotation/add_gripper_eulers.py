...
for i in range(start_index, max_len_data):
    ...
    processed_data = {"partial pcs": data["partial pcs"], "full pcs": data["full pcs"], "pos": data["pos"], "rot": data["rot"],
                    "gripper_eulers": gripper_eulers, "mani_point": data["mani_point"], "obj_name":data["obj_name"]}
