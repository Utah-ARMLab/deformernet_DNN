...
if __name__ == "__main__":
    ...
    train_len = 11800#11800 #9500
    test_len = 1200-8-191 #500
    ...
    weight_path = "/home/baothach/shape_servo_data/rotation_extension/multi_boxes_1000Pa/weights/run2(twist)/"
    # model.load_state_dict(torch.load(weight_path + "epoch " + str(70)))
