...
class PointCloudAE_v2(nn.Module):
    def __init__(self, normal_channel=True):
        super(PointCloudAE_v2, self).__init__()
        ...
        self.sa1 = PointNetSetAbstraction(npoint=256, radius=0.2, nsample=32, in_channel=6+additional_channel, mlp=[3], group_all=False)
        ...
        self.fp1 = PointNetFeaturePropagation(in_channel=6+additional_channel, mlp=[64, 32, 3+additional_channel])
