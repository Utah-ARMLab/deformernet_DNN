...
from architecture import DeformerNetManiPoint
from dataset_loader import SurgicalSetUpManiPointDataset
...
if __name__ == "__main__":
    ...
    dataset = SurgicalSetUpManiPointDataset(percentage = 1.0)
    ...
    model.load_state_dict(torch.load(weight_path + "epoch " + str(312)))
  
    optimizer = optim.Adam(model.parameters(), lr=0.01)
    scheduler = optim.lr_scheduler.StepLR(optimizer, 50, gamma=0.1)
    for epoch in range(313, 413):
