...
for i in range(10,20):    
    ...
    with torch.no_grad():
        ...
        heats = np.array([[success_probs_1[i], 0, 0] if success_probs_1[i]>=success_probs_2[i] else [0, success_probs_2[i], 0]\
        ...
        open3d.visualization.draw_geometries([pcd, mani_point_1.translate(tuple(gt_mp_1)), mani_point_2.translate(tuple(gt_mp_2)), \
