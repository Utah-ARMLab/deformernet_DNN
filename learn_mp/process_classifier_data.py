...
for i in range(start_index, max_len_data):
    ...
    processed_data = {"partial pcs": pcs, "label": label, "mani_point": data["mani_point"], "chamfer": data["chamfer"], \
                    "gt mani_point": data["gt mani_point"], "gt chamfer": data["gt chamfer"], "obj_name": data["obj_name"]} 
