...
if __name__ == "__main__":
    ...
    weight_path = f"/home/baothach/shape_servo_data/manipulation_points/multi_{args.obj_category}/weights/seg/object_centric"
    ...
    dataset = DensePredictorDataset(percentage = 1.0, dataset_path=dataset_path, shift_to_centroid=True)
